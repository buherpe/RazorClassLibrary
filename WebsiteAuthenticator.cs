...
public class WebsiteAuthenticator(ProtectedLocalStorage protectedLocalStorage, 
    IConfiguration configuration, DbContext dbContext) : AuthenticationStateProvider
{
    private IUsers _dbContext = (IUsers)dbContext;
    ...
    public async Task LoginAsync(LoginFormModel loginFormModel)
    {
        ...
        //if (user != null)
        {
            ...
            await protectedLocalStorage.SetAsync("identity", GenerateToken(user.Id));
        }
    ...
    public string GenerateToken(int userId)
    {
        ...
        new Claim("Id", userId.ToString()),
            ...
            Expires = DateTime.UtcNow.AddDays(configuration.GetValue<int>("Authentication:JwtBearer:ExpiresDays")),
